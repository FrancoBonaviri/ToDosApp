...
var UsuarioController = /** @class */ (function () {
    function UsuarioController() {
        ...
        this.getById = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, usuario_1.User.findById(id)];
                    case 2:
                        user = _a.sent();
        ...
        this.craete = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, UserName, Email, Password, hash, user, userDb, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, usuario_1.User.create(user)];
                    case 2:
                        userDb = _b.sent();
                        return [2 /*return*/, res.json({
                                ok: true,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        token = jsonwebtoken_1.default.sign({ Email: Email }, process.env.PRIVATE_KEY_JWT || "RANDOM_KEY");
                        return [2 /*return*/, res.json({
                                ok: true,
                                user: user,
                                token: token
